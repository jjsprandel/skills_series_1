...
# Install MSP430-CGT and support files
ENV MSP430_CGT_VERSION 21.6.1.LTS
ENV MSP430_CGT_INSTALLER_SRC ti_cgt_msp430_${MSP430_CGT_VERSION}_linux-x64_installer.bin

WORKDIR /msp430_cgt_install

RUN wget "https://dr-download.ti.com/software-development/ide-configuration-compiler-or-debugger/MD-p4jWEYpR8n/${MSP430_CGT_VERSION}/${MSP430_CGT_INSTALLER_SRC}"

RUN chmod +x ${MSP430_CGT_INSTALLER_SRC}

RUN /msp430_cgt_install/${MSP430_CGT_INSTALLER_SRC} --prefix /home/dev --mode unattended --unattendedmodeui minimal

RUN rm -r /msp430_cgt_install
